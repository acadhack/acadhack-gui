...
*   **🎨 Modern UI**: A sleek, dark-themed interface built with pywebview and web technologies, providing real-time feedback.
*   **🕵️ Stealth Mode**: Mimics human behavior with randomized delays to avoid detection.
*   **🚀 Booster Mode**: Specialized logic for the "Booster" quizzes.
